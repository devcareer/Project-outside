...
function ListArtist() {
  return (
    <div className="font-[Manrope] flex flex-col justify-center w-full max-w-2xl mx-auto">
        <h1 className="my-4 text-3xl md:text-4xl text-left w-full font-semibold">List an Artist</h1>
        <form className="space-y-3 grid grid-cols-1 sm:grid-cols-2 w-full gap-x-4 mb-5" action="">
            ...
            <button className="col-span-2 rounded-xl w-full bg-[#0C66E4] p-3 my-3 text-white">Create Artist</button>
        </form>
    </div>
  )
}
