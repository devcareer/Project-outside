...
import singleartist from '../assets/singleartist.png';
	...
	return (
		<div className="flex flex-col gap-10 items-center sm:flex-row sm:justify-around sm:items-stretch pt-1 text-sm">
			<div className="w-[35%] h-[auto] sm:w-[38%] md:w-[34%] ">
				<img src={singleartist} alt="single artist" />
			</div>
			...
			<div className="text-center sm:text-justify">
				...
				<div className="mt-5">
					...
					<div className="flex mt-3 gap-5 text-[#172B4D] text-xs sm:text-sm sm:hover:scale-x-110">
						...
						<Link to="sammy@gmail.com" className="underline">sammy@gmail.com</Link>
					</div>
					<div className="flex mt-3 gap-5 text-[#172B4D] text-xs sm:text-sm sm:hover:scale-x-110">
					...
					<div className="flex mt-3 gap-5 text-[#172B4D] text-xs sm:text-sm sm:hover:scale-x-110">
						...
						<Link to="https://www.instagram.com/sammy_sings" className="underline">
							https://www.instagram.com/sammy_sings
						</Link>
					</div>
				...
				<div className="mt-8 sm:mt-6">
					<div>
						...
						<p className="text-[#172B4D] text-xs mt-3 sm:hover:scale-x-110 sm:mt-1 sm:text-sm underline">
							<Link to="#">Karaoke Untammed</Link>
						</p>

						<p className="text-[#172B4D] mt-1 text-xs sm:hover:scale-x-110 sm:text-sm underline">
							<Link to="#">A night with Burna boy</Link>
						</p>
					</div>
					<div className="mt-6 sm:mt-4">
						<h1 className="font-black text-l sm:text-xl">Past Shows</h1>
						<p className="text-[#172B4D] mt-3 text-xs sm:hover:scale-x-110 sm:text-sm sm:mt-1 underline">
